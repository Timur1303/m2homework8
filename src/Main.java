...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        bigDictionary.put("большой", new String[]{"огромный", "громадный", "великий", "колосальный"});
        bigDictionary.put("человек", new String[]{"персона", "миледи", "личность", "гражданин"});
        bigDictionary.put("красивый", new String[]{"привлекательный", "обоятельный", "симпатичный", "прекрасный", "приятный"});
        bigDictionary.put("дом", new String[]{"квартира", "жилище", "вилла", "комуналка", "хата", "особняк"});
        ...
        while (iterator.hasNext()) {
            ...
            for (int i = 0; i < word.length ; i++) {
                ...
                newWord.addAll(Arrays.asList(word));
                newWord.remove(newKey);
                newWord.add(key);
                String[] arrayConvert;
                arrayConvert = newWord.toArray(new String[0]);
                bigDictionary.put(newKey, arrayConvert);
            }
        }
